...
import in.nighthawk.wificonqrer.Network.WiFiDirectBroadcastReceiver;
...
public class WiFiDirectActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button openDbButton = (Button) findViewById(R.id.open_db_button);
        openDbButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(WiFiDirectActivity.this, ScanDatabaseActivity.class));
            }
        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Start Scanner", Snackbar.LENGTH_LONG)
